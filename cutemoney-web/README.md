...
A cute, simple money tracker that runs entirely as a static site —
perfect for hosting free on **GitHub Pages**. No backend, no build
...
That's it — it's live, free, and HTTPS by default. Any time you push
new commits to `main`, the site updates automatically.
